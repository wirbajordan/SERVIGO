...
$stmt = $db->prepare("SELECT sp.*, u.first_name, u.last_name, u.city, u.region, u.profile_image, u.id as user_id FROM service_providers sp JOIN users u ON sp.user_id = u.id WHERE sp.id = ?");
    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card p-3 text-center">
                ...
                <div class="mb-2"><i class="fas fa-map-marker-alt text-primary-servigo"></i> <?php echo htmlspecialchars($provider['city']); ?>, <?php echo htmlspecialchars($provider['region']); ?></div>
